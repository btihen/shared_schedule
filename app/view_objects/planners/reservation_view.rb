class Planners::ReservationView < ViewObject
  ...
  def event
    @event ||= Planners::EventView.new(reservation.event)
  end

  def space
    @space ||= Planners::SpaceView.new(reservation.space)
  end

  def end_time_slot
    @end_time_slot ||= Planners::TimeSlotView.new(reservation.end_time_slot)
  end

  def start_time_slot
    @start_time_slot ||= Planners::TimeSlotView.new(reservation.start_time_slot)
  end
