class Planners::SpaceView < ViewObject
  ...
  def tenant
    Planners::TenantView.new(space.tenant)
  end
  ...
  def events
    Planners::EventView.collection(space.events)
  end

  def allowed_time_slots
    Planners::TimeSlotView.collection(space.allowed_time_slots)
  end

  def reservations(date_range=nil)
    return Planners::ReservationView.collection(space.reservations) if date_range.nil?

    Planners::ReservationView.collection( space.reservations.in_date_range(date_range) )
  end
