class Guests::ReservationView < ViewObject
  ...
  def event
    @event  ||= Guests::EventView.new(reservation.event)
  end

  def space
    @space  ||= Guests::SpaceView.new(reservation.space)
  end

  def end_time_slot
    @end_time_slot   ||= Guests::TimeSlotView.new(reservation.end_time_slot)
  end

  def start_time_slot
    @start_time_slot ||= Guests::TimeSlotView.new(reservation.start_time_slot)
  end
