class Managers::ReservationsController < Managers::AppController
  ...
  def new
    ...
    respond_to do |format|
      format.html { render 'managers/reservations/new', locals: {user: user_view,
                                                        space: space_view,
                                                        tenant: tenant_view,
  ...
  def create
    ...
    if reservation_form.valid?
      ...
      respond_to do |format|
        ...
        format.html { render 'managers/reservations/new',
  ...
  def edit
    ...
    respond_to do |format|
      format.html { render 'managers/reservations/edit',
                            locals: { user: user_view,
                                      space: space_view,
                                      tenant: tenant_view,
                                      reservation: reservation_form } }
